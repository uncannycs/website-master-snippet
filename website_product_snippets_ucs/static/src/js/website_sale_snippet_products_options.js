odoo.define('website_product_template_snippet.s_dynamic_snippet_products_template_options', function (require) {
'use strict';
...
const dynamicSnippetProductsOptionsTemplate = s_dynamic_snippet_carousel_options.extend({
...
options.registry.dynamic_snippet_products_template = dynamicSnippetProductsOptionsTemplate;

return dynamicSnippetProductsOptionsTemplate;
});
