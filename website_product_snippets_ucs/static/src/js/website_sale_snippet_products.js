odoo.define('website_product_template_snippet.s_dynamic_snippet_products_template', function (require) {
'use strict';
...
const DynamicSnippetProductsTemplate = DynamicSnippetCarousel.extend({
    selector: '.s_dynamic_snippet_products_template',
...
const DynamicSnippetProductsTemplateCard = publicWidget.Widget.extend({
...
//publicWidget.registry.dynamic_snippet_products_cta = DynamicSnippetProductsTemplate;
publicWidget.registry.dynamic_snippet_products_template = DynamicSnippetProductsTemplate;

return DynamicSnippetProductsTemplate;
});
